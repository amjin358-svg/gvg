...
import { OPS_MODULE_NAV, OPS_NAV } from "@/frontend/data/operations/content";
      ...
      <Container className="grid gap-8 py-8 lg:grid-cols-[260px_1fr]">
        <aside className="h-fit rounded-xl border border-[var(--color-line)] bg-white p-4">
          <div className="mb-4 flex items-center gap-2 px-2">
            <Network className="h-4 w-4 text-[var(--color-navy)]" />
            <div>
              <p className="text-sm font-semibold text-[var(--color-navy)]">Operations Dashboard</p>
              <p className="text-xs text-[var(--color-muted)]">GVG 營運儀表板</p>
            </div>
          </div>
          ...
          <p className="mt-5 px-2 text-[11px] font-semibold uppercase tracking-[0.12em] text-[var(--color-muted)]">
            Modules
          </p>
          <ul className="mt-2 space-y-1">
            {OPS_MODULE_NAV.map((item) => {
                ...
                <li key={item.href}>
                  <Link
                    ...
                    className={cn(
                      ...
                      active
                        ? "bg-[var(--color-mist)] font-semibold text-[var(--color-navy)]"
        ...
        <div>
          <p className="text-xs text-[var(--color-muted)]">首頁 &gt; 營運儀表板 &gt; {titleZh}</p>
