...
import { DEV_DOC_NAV, DEV_NAV } from "@/frontend/data/development/content";
      ...
      <Container className="grid gap-8 py-8 lg:grid-cols-[260px_1fr]">
        <aside className="h-fit rounded-xl border border-[var(--color-line)] bg-white p-4">
          <div className="mb-4 flex items-center gap-2 px-2">
            <Code2 className="h-4 w-4 text-[var(--color-navy)]" />
            <div>
              <p className="text-sm font-semibold text-[var(--color-navy)]">Development Dashboard</p>
              <p className="text-xs text-[var(--color-muted)]">GVG 開發儀表板</p>
            </div>
          </div>
        ...
        <div>
          <p className="text-xs text-[var(--color-muted)]">首頁 &gt; 開發儀表板 &gt; {titleZh}</p>
